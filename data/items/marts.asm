...
LavenderMartClerkText::
	script_mart GREAT_BALL, SUPER_POTION, REVIVE, ESCAPE_ROPE, SUPER_REPEL, ANTIDOTE, ICE_HEAL, PARLYZ_HEAL, TM_SHADOW_BALL

CeladonMart2FClerkText::
...
CeladonMart3FClerk1Text::
	script_mart TM_SUBMISSION, TM_CROSS_CHOP, TM_SEISMIC_TOSS, TM_COUNTER, TM_SLUDGE_BOMB, TM_BLIZZARD, TM_THUNDER, TM_SOLARBEAM, TM_SOFTBOILED

CeladonMart3FClerk2Text::
	script_mart TM_MEGA_PUNCH, TM_MEGA_KICK, TM_DOUBLE_EDGE, TM_BODY_SLAM, TM_EXPLOSION, TM_SWORDS_DANCE, TM_REFLECT, TM_DOUBLE_TEAM, TM_REST
...
IndigoPlateauLobbyClerkText::
	script_mart ULTRA_BALL, GREAT_BALL, FULL_RESTORE, MAX_POTION, FULL_HEAL, REVIVE, MAX_REPEL, MAX_ETHER, TM_DRAGON_PULSE
