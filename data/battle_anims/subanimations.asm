...
Subanim_0SliceReverse:
	subanim SUBANIMTYPE_HFLIP, 12
	db FRAMEBLOCK_2A, BASECOORD_2A, FRAMEBLOCKMODE_00
	db FRAMEBLOCK_7A, BASECOORD_2A, FRAMEBLOCKMODE_02
	db FRAMEBLOCK_7A, BASECOORD_07, FRAMEBLOCKMODE_02
	db FRAMEBLOCK_2A, BASECOORD_0F, FRAMEBLOCKMODE_04
	db FRAMEBLOCK_7A, BASECOORD_0F, FRAMEBLOCKMODE_02
	db FRAMEBLOCK_7A, BASECOORD_17, FRAMEBLOCKMODE_02
	db FRAMEBLOCK_2A, BASECOORD_1D, FRAMEBLOCKMODE_04
	db FRAMEBLOCK_7A, BASECOORD_1D, FRAMEBLOCKMODE_02
	db FRAMEBLOCK_7A, BASECOORD_23, FRAMEBLOCKMODE_02
