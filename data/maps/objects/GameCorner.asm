	...
	const_export GAMECORNER_CLERK3
...
GameCorner_Object:
	...
	object_event  4,  6, SPRITE_CLERK, STAY, DOWN, TEXT_GAMECORNER_CLERK1
	object_event  6,  6, SPRITE_CLERK, STAY, DOWN, TEXT_GAMECORNER_CLERK3
