...
ViridianGymHS:
	...
	db VIRIDIAN_GYM, VIRIDIANGYM_TM27,     SHOW
Museum1FHS:
...
MtMoon1FHS:
	...
	db MT_MOON_1F, MTMOON1F_TM_EGG_BOMB,  SHOW
MtMoonB2FHS:
...
SSAnneB1FRoomsHS:
	...
	db SS_ANNE_B1F_ROOMS, SSANNEB1FROOMS_TM_DRAGON_RAGE, SHOW
...
RocketHideoutB4FHS:
	...
	db ROCKET_HIDEOUT_B4F, ROCKETHIDEOUTB4F_TM_CROSS_CHOP, SHOW
...
FarawayIslandHS:
	db FARAWAY_ISLAND, FARAWAYISLAND_MEW, SHOW
PokemonMansion2FHS:
...
IndigoPlateauHS:
	db INDIGO_PLATEAU, INDIGOPLATEAU_TRAINERM, 	  HIDE
	db INDIGO_PLATEAU, INDIGOPLATEAU_TRAINERF, 	  HIDE
	db INDIGO_PLATEAU, INDIGOPLATEAU_MASTER_BALL, HIDE
	db INDIGO_PLATEAU, INDIGOPLATEAU_MAX_ELIXER,  SHOW
