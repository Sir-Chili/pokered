...
; commands that are used to go to the next set of credits texts.
	...
	db CRED_DELUXE, CRED_TEXT_FADE_MON
	db CRED_DELUXE_MADE_BY, CRED_KNOWNASCHUCK, CRED_TEXT_FADE
	db CRED_SPRITES, CRED_KNOWNASCHUCK, CRED_OMEGAZEEZ, CRED_YESILOVENACHOS, CRED_TEXT_FADE
	db CRED_SPRITES, CRED_BLUE_EMERALD, CRED_CHAMBER, CRED_SOLOO993, CRED_TEXT
	db CRED_PLAYTESTERS, CRED_DARKJP04, CRED_HOUMAR95, CRED_BOOMWATER, CRED_TEXT_FADE
