...
; Route 11
	...
	db 17, RATTATA, CHARMANDER, RATICATE, 0
...
; Route 19
	...
	db 27, HORSEA, TENTACOOL, SQUIRTLE, GOLDEEN, 0
	db 29, GOLDEEN, SHELLDER, SEAKING, 0
	db 30, HORSEA, HORSEA, 0
	db 27, TENTACOOL, SQUIRTLE, STARYU, HORSEA, TENTACRUEL, 0
; Route 20
	db 31, SHELLDER, CLOYSTER, 0
	db 35, STARYU, 0
...
IF DEF(_BLUE)
ProfOakData:
	db $FF, 81, NIDOKING, 84, WIGGLYTUFF, 82, ELECTRODE, 83, NINETALES, 84, BLASTOISE, 85, TAUROS, 0
	db $FF, 81, NIDOKING, 84, WIGGLYTUFF, 82, NINETALES, 83, KINGLER, 84, VENUSAUR, 85, TAUROS, 0
	db $FF, 81, NIDOKING, 84, WIGGLYTUFF, 82, KINGLER, 83, ELECTRODE, 84, CHARIZARD, 85, TAUROS, 0
ENDC

IF DEF(_RED)
ProfOakData:
	db $FF, 81, WIGGLYTUFF, 84, NIDOKING, 82, ELECTRODE, 83, NINETALES, 84, BLASTOISE, 85, TAUROS, 0
	db $FF, 81, WIGGLYTUFF, 84, NIDOKING, 82, NINETALES, 83, KINGLER, 84, VENUSAUR, 85, TAUROS, 0
	db $FF, 81, WIGGLYTUFF, 84, NIDOKING, 82, KINGLER, 83, ELECTRODE, 84, CHARIZARD, 85, TAUROS, 0
ENDC
...
GiovanniData:
; Rocket Hideout B4F
	db $FF, 25, NIDORINA, 24, RHYHORN, 29, RATICATE, 0
; Silph Co. 11F
	db $FF, 37, NIDORINO, 35, RATICATE, 37, RHYHORN, 41, NIDOQUEEN, 0
; Viridian Gym
	db $FF, 45, NIDOKING, 42, DUGTRIO, 44, RATICATE, 45, NIDOQUEEN, 50, RHYDON, 0
; Rematch
	db $FF, 65, DUGTRIO, 66, NIDOQUEEN, 66, NIDOKING, 67, SANDSLASH, 68, RATICATE, 69, RHYDON, 0
...
BrunoData:
	db $FF, 53, DODRIO, 55, HITMONCHAN, 55, HITMONLEE, 56, PINSIR, 58, MACHAMP, 0
; Rematch
	db $FF, 73, DODRIO, 74, HITMONCHAN, 74, HITMONLEE, 75, MR_MIME, 76, PINSIR, 77, MACHAMP, 0

BrockData:
	db $FF, 12, GEODUDE, 14, ONIX, 0
; Rematch
	db $FF, 58, MUK, 59, OMASTAR, 59, KABUTOPS, 60, AERODACTYL, 61, GOLEM, 62, ONIX, 0

MistyData:
	db $FF, 18, PSYDUCK, 21, STARMIE, 0
; Rematch
	db $FF, 59, SEADRA, 60, SLOWBRO, 60, POLIWRATH, 61, VAPOREON, 62, GOLDUCK, 63, STARMIE, 0

LtSurgeData:
	db $FF, 21, VOLTORB, 18, MAGNEMITE, 24, RAICHU, 0
; Rematch
	db $FF, 60, MAGNETON, 61, SEAKING, 61, ELECTABUZZ, 62, JOLTEON, 63, ELECTRODE, 64, RAICHU, 0

ErikaData:
	db $FF, 29, VICTREEBEL, 24, TANGELA, 29, VILEPLUME, 0
; Rematch
	db $FF, 61, TANGELA, 62, EXEGGUTOR, 62, FARFETCHD, 63, VENUSAUR, 64, VICTREEBEL, 65, VILEPLUME, 0

KogaData:
	db $FF, 37, WEEZING, 39, GOLBAT, 37, ARBOK, 43, VENOMOTH, 0
; Rematch
	db $FF, 62, BEEDRILL, 63, WEEZING, 63, ARBOK, 64, TENTACRUEL, 65, GOLBAT, 66, VENOMOTH, 0

BlaineData:
	db $FF, 42, MAGMAR, 40, NINETALES, 42, RAPIDASH, 47, ARCANINE, 0
; Rematch
	db $FF, 64, NINETALES, 65, MAGMAR, 65, CHARIZARD, 66, FLAREON, 67, RAPIDASH, 68, ARCANINE, 0

SabrinaData:
	db $FF, 38, MR_MIME, 37, BUTTERFREE, 38, HYPNO, 43, ALAKAZAM, 0
; Rematch
	db $FF, 63, BUTTERFREE, 64, WIGGLYTUFF, 64, JYNX, 65, MR_MIME, 66, HYPNO, 67, ALAKAZAM, 0
...
; Rematch
	db $FF, 77, PIDGEOT, 76, ALAKAZAM, 77, RHYDON, 78, ARCANINE, 79, EXEGGUTOR, 80, BLASTOISE, 0
	db $FF, 77, PIDGEOT, 76, ALAKAZAM, 77, RHYDON, 78, GYARADOS, 79, ARCANINE, 80, VENUSAUR, 0
	db $FF, 77, PIDGEOT, 76, ALAKAZAM, 77, RHYDON, 78, EXEGGUTOR, 79, GYARADOS, 80, CHARIZARD, 0

LoreleiData:
	db $FF, 54, DEWGONG, 53, CLOYSTER, 54, SANDSLASH, 56, JYNX, 56, LAPRAS, 0
; Rematch
	db $FF, 73, DEWGONG, 72, CLOYSTER, 73, SANDSLASH, 74, MAGNETON, 75, JYNX, 76, LAPRAS, 0
...
; Pokémon Tower 5F
	...
	db 22, HAUNTER, 0
; Pokémon Tower 6F
	db 22, GASTLY, MAGMAR, DROWZEE, 0
	db 24, GASTLY, 0
	db 24, DROWZEE, 0
; Saffron Gym
	db 34, GASTLY, HAUNTER, 0
	db 38, HAUNTER, 0
	db 33, GASTLY, DROWZEE, HAUNTER, 0

AgathaData:
	db $FF, 56, MAROWAK, 56, PRIMEAPE, 55, PARASECT, 58, HYPNO, 60, GENGAR, 0
; Rematch
	db $FF, 75, MAROWAK, 75, PRIMEAPE, 74, PARASECT, 76, MAGMAR, 77, HYPNO, 78, GENGAR, 0

LanceData:
	db $FF, 58, GYARADOS, 56, ARBOK, 56, CHARIZARD, 60, AERODACTYL, 62, DRAGONITE, 0
; Rematch
	db $FF, 77, GYARADOS, 76, ARBOK, 76, CHARIZARD, 75, SEADRA, 78, AERODACTYL, 79, DRAGONITE, 0

TrainerMData:
	db $FF, 80, LAPRAS, 82, SNORLAX, 84, VENUSAUR, 84, BLASTOISE, 84, CHARIZARD, 88, PIKACHU, 0
	
TrainerFData:
	db $FF, 80, GENGAR, 82, CLEFABLE, 84, BLASTOISE, 84, CHARIZARD, 84, VENUSAUR, 88, EEVEE, 0